...
import com.EdwinLaguna.exceptions.UserAssertionErros;
import cucumber.api.java.en.Then;
import cucumber.api.java.en.When;

import static com.EdwinLaguna.exceptions.UserAssertionErros.*;
import static com.EdwinLaguna.questions.UserQuestions.allTheExpectedUsers;
import static com.EdwinLaguna.questions.UserQuestions.theExpectedUser;
import static com.EdwinLaguna.task.UserTasks.*;
...
public class WhenManagingUsers {
    ...
    @When("Agregar un usuario con nombre {string} y apellido {string}")
    public void agregarUsuario(String firstName, String lastName) {
